...
def remaining_qs_unpacker():
    global remaining_questions_today, remaining_questions_yesterday
...
def greet(status, recall=False):
    global user_name, remaining_questions_yesterday, remaining_questions_today, daily_goal, today_weekday
...
def user_handler():
    global daily_goal, user_name, remaining_questions_yesterday, remaining_questions_today
    while True:
